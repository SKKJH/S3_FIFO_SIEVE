...
typedef cache_obj_t *(*cache_insert_33_func_ptr)(cache_t *, const request_t *);

typedef cache_obj_t *(*cache_insert_66_func_ptr)(cache_t *, const request_t *);
...
struct cache {
  ...
  cache_insert_33_func_ptr insert_33;
  cache_insert_66_func_ptr insert_66;
